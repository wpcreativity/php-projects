...
class Twitter extends CI_Controller
{
	...
	public function auth()
	{
			...
			$request_token = $this->connection->getRequestToken(base_url('callback'));
	...
	public function callback()
	{
		...
		else
		{
			...
			$this->load->model('General_model');
				$this->General_model->twiter_register($access_token);
		
				// $this->session->set_userdata('img', $access_token['profile_image_url']);
				// $this->session->set_userdata('email', $access_token['profile_image_url']);
